      ...
      <SafeAreaView style={styles.container}>
          <ScrollView showsVerticalScrollIndicator={false}>
              <View style={styles.titleBar}>
                  <Ionicons name="ios-arrow-back" size={24} color="#52575D" onPress={() =>this.props.navigation.goBack()}></Ionicons>
              </View>
              ...
              <View style={styles.statsContainer}>
                  <View style={styles.statsBox}>
                      ...
                      <Text style={[styles.text, styles.subText]}>Free Coffee</Text>
                  </View>
                  <View style={[styles.statsBox, { borderColor: "#DFD8C8", borderLeftWidth: 1, borderRightWidth: 1 }]}>
                      <Text style={[styles.text, { fontSize: 24 }]}>$140</Text>
              ...
              <Text style={[styles.subText, styles.recent]}>Previous Orders</Text>
              <View style={{ alignItems: "center" }}>
                  <View style={styles.recentItem}>
                      <View style={styles.activityIndicator}></View>
                      <View style={{ width: 250 }}>
                          <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                              25th May <Text style={{ fontWeight: "400" }}>2 Cappacinno</Text> and <Text style={{ fontWeight: "400" }}>a Latte</Text>
                          </Text>
                      </View>
                  </View>
                  ...
                  <View style={styles.recentItem}>
                      ...
                      <View style={{ width: 250 }}>
                          <Text style={[styles.text, { color: "#41444B", fontWeight: "300" }]}>
                              10th May <Text style={{ fontWeight: "400" }}>2 Long Black</Text>
                          </Text>
                      </View>
                  </View>
              </View>
